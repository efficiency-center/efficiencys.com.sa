...
export const STORY_CARDS: StoryCard[] = [
  ...
  {
    src: "/assets/imgs/stories/drinking-coffee.jpg",
    alt: "Drinking coffee at the center",
    headline: "first cup of the day",
    body: "",
  },
  {
    src: "/assets/imgs/stories/office-with-a-view.jpg",
  ...
  {
    src: "/assets/imgs/stories/work-in-a-shared-space.jpg",
    alt: "Working in a shared workspace",
    headline: "deep work mode",
    body: "",
  },
  {
    src: "/assets/imgs/stories/setting-in-the-businessloung.jpg",
    alt: "Sitting in the business lounge",
    headline: "between meetings",
    body: "",
  },
  {
    src: "/assets/imgs/stories/brainstorm-together.jpg",
    alt: "Team brainstorming together",
    headline: "planning Q3",
    body: "",
  },
  {
    src: "/assets/imgs/stories/watching0the-view.jpg",
    alt: "Watching the view from the center",
    headline: "the view never gets old",
    body: "",
  },
  {
    src: "/assets/imgs/stories/take-a-break.jpg",
  ...
  {
    src: "/assets/imgs/stories/coffee.jpg",
    alt: "Coffee moment",
    headline: "fuel",
    body: "",
  },
